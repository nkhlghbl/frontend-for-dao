...
export declare function useTransactionStore(): {
    ...
    setProvider: (newProvider: {
        ...
        estimateContractGas: <TChain extends unknown, TAbi_1 extends unknown, TFunctionName extends string>(args: import("viem").EstimateContractGasParameters<TAbi_1, TFunctionName, TChain>) => Promise<bigint>;
